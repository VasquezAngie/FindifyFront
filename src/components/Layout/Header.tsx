...
const Header = () => {
    ...
    return (
        <div className="Header bg-[#E8F8F7] p-4 flex justify-between items-center"> 
            <div className="flex items-center space-x-8">
                <img src="src/assets/Logo/logo_findy_prov.png" alt="Logo Findy Prov" className="w-25 h-25" />
